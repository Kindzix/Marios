...
public class MarioService {
    ...
    private void printOlgaUserUuid() {
        User olgaUser = userRepository.findByFirstName("Olga");
        if (olgaUser != null) {
            System.out.println("UUID użytkownika Olga: " + olgaUser.getUuid());
        } else {
            System.out.println("Nie znaleziono użytkownika o imieniu Olga.");
        }
    }
